    ...
    fun start() {
        ...
        btnsave.setOnClickListener {
            ...
            val addRunnable = Runnable {
                val newGameNormalDB = GameNormal(localdatatime, asset, cash, bought, sold, evaluation, profit, profitrate, profittot, profityear,"저장", 0F,0F,0, 0 , quant1x, quant3x, quantinv1x, quantinv3x,
                        ...
                        pr1x, pr3x, prinv1x, prinv3x, tradecomtot,0F, dividendtot, taxtot , "nothing", 0,0,0, endpoint)
