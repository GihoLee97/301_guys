...
//
//class FriendInviteAdapter(val context: Context, var game: List<GameNormal>, val itemClick: (GameNormal)->Unit): RecyclerView.Adapter<FriendInviteAdapter.MyViewHolder>() {
