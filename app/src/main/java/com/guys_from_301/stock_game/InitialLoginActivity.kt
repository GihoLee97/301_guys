...
class InitialLoginActivity : AppCompatActivity() {
    ...
    private var rewardList = arrayListOf<String>("1,000스택", "2,000스택", "3,000스택", "5,000스택", "6,000스택", "7,000스택", "8,000스택", "9,000스택", "10,000스택", "20,000스택",
            "1,000스택", "2,000스택", "3,000스택", "5,000스택", "10,000스택", // 시장대비 수익률
            "10,000스택", "20,000스택", "30,000스택", "50,000스택", "100,000스택", // 누적 거래일
            "10,000스택", "40,000스택", "160,000스택", "640,000스택", "2,560,000스택", // 연속 수익
            "1,000스택", "5,000스택", "10,000스택", "50,000스택", "100,000스택", // 투자 완료
            "50,000스택")
    //gameSetDb
