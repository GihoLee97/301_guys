...
//            v.findViewById<Button>(R.id.btn_sell).setBackgroundResource(R.drawable.trade_unchoosen)
//            v.findViewById<Button>(R.id.btn_buy).setBackgroundResource(R.drawable.trade_buy)
//        }
//        v.findViewById<Button>(R.id.btn_sell).setOnClickListener{
//            v.findViewById<Button>(R.id.btn_buy).setBackgroundResource(R.drawable.trade_unchoosen)
//            v.findViewById<Button>(R.id.btn_sell).setBackgroundResource(R.drawable.trade_buy)
//        }
