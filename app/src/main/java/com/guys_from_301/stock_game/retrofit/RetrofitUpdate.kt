...
// update
fun update(u_id: String, u_pw: String,u_money : Int, u_value1: Int, u_nickname:String, u_profit:Float, u_roundcount:Int, u_history:Int, u_level:Int, u_quest:Int) {
    ...
    funupdate.update(u_id, u_pw, u_money, u_value1, u_nickname, u_profit, u_roundcount, u_history, u_level, u_quest).enqueue(object : Callback<String> {
