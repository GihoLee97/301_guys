...
import com._301_guys.stock_game.data.Profile
import com._301_guys.stock_game.data.ProflieDB
...
fun getinformation(context: Context, u_id: String, u_pw: String) {
    ...
    fungetinformation.getall(com._301_guys.stock_game.getHash(u_id).trim(), com._301_guys.stock_game.getHash(u_pw).trim()).enqueue(object : Callback<DATACLASS> {
